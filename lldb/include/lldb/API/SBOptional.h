...
public:
  ...
  SBOptional(lldb::SBBreakpointList value)
      : m_kind(Kind::SBBreakpointList), m_storage(value) {}
  ...
  SBOptional(lldb::SBCommunication value)
      : m_kind(Kind::SBCommunication), m_storage(value) {}
  ...
  SBOptional(lldb::SBLaunchInfo value)
      : m_kind(Kind::SBLaunchInfo), m_storage(value) {}
  ...
  SBOptional(lldb::SBProgress value)
      : m_kind(Kind::SBProgress), m_storage(value) {}
  ...
  SBOptional(lldb::SBScriptObject value)
      : m_kind(Kind::SBScriptObject), m_storage(value) {}
  SBOptional(lldb::SBSection value)
      : m_kind(Kind::SBSection), m_storage(value) {}
  SBOptional(lldb::SBSourceManager value)
      : m_kind(Kind::SBSourceManager), m_storage(value) {}
  SBOptional(lldb::SBStatisticsOptions value)
      : m_kind(Kind::SBStatisticsOptions), m_storage(value) {}
  SBOptional(lldb::SBStream value) : m_kind(Kind::SBStream), m_storage(value) {}
  ...
  lldb::SBStream GetSBStream() const {
    if (const lldb::SBStream *value = std::any_cast<lldb::SBStream>(&m_storage))
      *value;
    return {};
  }
