...
#ifndef LLDB_INTERPRETER_OPERATING_SYSTEM_INTERFACE_H
#define LLDB_INTERPRETER_OPERATING_SYSTEM_INTERFACE_H
...
#endif // LLDB_INTERPRETER_SCRIPTED_THREAD_INTERFACE_H
