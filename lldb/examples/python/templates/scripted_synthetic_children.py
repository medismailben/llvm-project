...
class ScriptedSyntheticChildren(metaclass=ABCMeta):
    ...
    def __init__(self, valobj, internal_dict):
        ...
        Args:
            valobj (lldb.SBValue): The value this provider generates children
                for.
            internal_dict (dict): The session dictionary for the embedded
                interpreter, unused in most implementations.
        """
        self.valobj = valobj
    ...
    def get_value(self):
        """Override the value shown for this synthetic value itself,
        alongside its children.

        Returns:
            lldb.SBValue: The value to display, or `None` to keep the
