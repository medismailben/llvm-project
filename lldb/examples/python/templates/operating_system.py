...
class OperatingSystem(ScriptedThread):
    ...
    def __init__(self, process):
        """Initialization needs a valid lldb.SBProcess object.
    ...
    def create_thread(self, tid, context):
        ...
        This method is called manually, using the SBAPI `lldb.SBProcess.CreateOSPluginThread` affordance.
    ...
    def get_thread_info(self):
        ...
        This method get called automatically every time the process stops and it needs to update its thread list.
    ...
    def get_register_data(self, tid):
        ...
        This method is called when unwinding the stack of one of the operating system thread.
