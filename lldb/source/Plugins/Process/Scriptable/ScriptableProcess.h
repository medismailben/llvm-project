...
class ScriptableProcess : public Process {
public:
  ...
  ScriptableProcess(lldb::TargetSP target_sp, lldb::ListenerSP listener_sp,
                    const FileSpec &core_file, lldb::DataBufferSP code_data);

  ~ScriptableProcess() override;
...
class CommandObjectMultiwordScriptableProcess : public CommandObjectMultiword {
public:
  CommandObjectMultiwordScriptableProcess(CommandInterpreter &interpreter);
  ~CommandObjectMultiwordScriptableProcess() override {}
};
